...
SOURCEDIR = '/media/bfortuner/bigguy/data/sealions/sample/'

DATADIR = '/media/bfortuner/bigguy/data/sealions/sample/'
...
class SeaLionData(object):
    ...
    def __init__(self, sourcedir=SOURCEDIR, datadir=DATADIR, verbosity=VERBOSITY.NORMAL):
        ...
        self.paths = {
            ...
            'dotted'     : os.path.join(sourcedir, 'traintotted', '{tid}.jpg'),
